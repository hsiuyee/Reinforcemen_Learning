...
import sys
sys.path.append('/content/gdrive/MyDrive/Anti_exploration_RL')
...
def experiment(variant):
    ...
    if not variant['offline']:
        ...
        checkpoint = '/content/models/AE_Jun-11-2024_1531_antmaze-umaze.pt' # new add
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env", type=str, default='antmaze-umaze')
    ...
    # bonus
    parser.add_argument('--offline', action='store_true', default=True, help='offline sac') #default=False
    ...
    # noinspection
    bonus_path = '/content/models/{}'.format(args.bonus_model)
    bonus_path = '/content/models/AE_Jun-11-2024_1531_antmaze-umaze.pt'
    print(bonus_path)
