...
if __name__ == "__main__":
    ...
    parser.add_argument("--rate", default=0.005, type=float)   
    ...
    # Initialize policy
    if args.policy == 'IQL':
        policy = IQL.Distribution_IQL(**kwargs)
    else:
